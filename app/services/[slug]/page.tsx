...
import Rectanglecurve from '../../../components/assets/img/Rectanglecurve.png'
        ...
        <section className="relative h-[700px] flex items-center justify-center text-center text-white p-0 overflow-hidden">
          ...
          <div className="bg-about-background bg-cover bg-center w-full h-full flex ">
            ...
            <div className="relative z-10 max-w-[860px] mx-auto px-4 m-auto">
              <h1 className="text-4xl  font-[700] leading-[95px] md:text-[72px] font-bold mb-0 text-white capitalize">
              {slug}
              </h1>
            </div>
          ...
          <div className="mx-auto px-2 relative z-[99] py-4">
            ...
            <div className="mt-[80px]">
              ...
              <div className="workprocess ">
                <div className=" max-w-[1400px] mx-auto grid  grid-cols-1 lg:grid-cols-3 gap-[100px_50px]">
        ...
        <section className="bg-[#F6FBFD]">
          <div>
            ...
            <div className="max-w-[1400px] mx-auto py-10">
              <div className="lg:flex mx-auto w-full overflow-hidden">
                <div data-aos="zoom-in" className="mx-auto card-box relative max-w-[400px] text-center px-8 py-4">
                  <Image src={Rectanglecurve} alt="" className="absolute text-transparent w-full h-full max-w-full inset-x-0" />
                  <div className="relative z-[99]">
                ...
                <div data-aos="zoom-in"  className="mx-auto card-box relative max-w-[500px] text-center px-8 py-4 scale-[115%]">
                  <Image src={Rectanglecurve} alt="" className="absolute text-transparent w-full h-full max-w-full inset-x-0" />
                  <div className="relative z-[99]">
                    <div className="bg-[#0ECFDB] rounded-[23px] inline-block px-4 py-3">
                      <svg width="39" height="65" viewBox="0 0 39 65" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <section>
          <div className="max-w-[1400px] mx-auto px-2">
           <div className="max-w-[900px]">
            <h4 className="text-[44px] leading-[60px] ">Our Project</h4>
            <p>I have worked on many projects over the course of being a Web Developer, here are a few of my live, real-world projectsI have worked on many projects over the course of being a Web Developer, here are a few of my live, real-world projects</p>
           </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div data-aos="zoom-in" className="max-w-[300px] rounded-[8px] border border-solid border-[#1E96D3] p-2">
              ...
              <div className="max-w-[300px] rounded-[8px] border border-solid border-[#1E96D3] p-2">
