...
const ContactUs = () => {
    return (<>
        <div className="mt-[90px]">
            ...
            <div>
                <div className="mx-auto max-w-[1200px] p-4 md:p-6 lg:p-8 my-6">
                    <div className="rounded-xl overflow-hidden shadow-[1px_4px_17px_2px_#00000038] flex flex-col md:flex-row p-2">
                        <div className="bg-[#1E96D3] text-white md:w-[45%] relative p-[40px] rounded-[16px] flex flex-col justify-between min-h-[600px] ">
            ...
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3679.4805698539294!2d75.89368257592147!3d22.747540126534744!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3962fd0267024913%3A0x9a995d6abcd51279!2sKrozzon!5e0!3m2!1sen!2sin!4v1739166184433!5m2!1sen!2sin" width="100%" height="450" style={{border:"0"}} allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div>
    </>)
}
