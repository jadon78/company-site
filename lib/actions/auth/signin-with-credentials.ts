...
export const signInWithCredentials = async (
  ...
  console.log({callbackUrl},"klllkkkkkkkkkkkk")
  const validatedFields = SignInValidation.safeParse(values)
console.log(validatedFields,"oooooooooooo");
...
console.log(staticAdminCredentials,"staticAdminCredentials");

  if (email === staticAdminCredentials.email && password === staticAdminCredentials.password) {
    return { url: callbackUrl || routes.defaultLoginRedirect }; // Redirect for admin
  }
